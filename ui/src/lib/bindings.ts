...
const ARGS_MAP = {
  "":
    "{\"remove_bootstrap_node\":[\"key\"],\"new_node\":[],\"get_record\":[\"node_key\",\"record_key\"],\"record_store_changed\":[\"records\"],\"put_record\":[\"node_key\",\"record_key\",\"value\"],\"remove_record\":[\"node_key\",\"record_key\"],\"add_bootstrap_node\":[\"key\"],\"close_node\":[\"node_id\"],\"routing_table_changed\":[\"routing_table\"],\"bootstrap_nodes_changed\":[\"bootstrap_nodes\"]}",
};

...
export type TauRpcApiInputTypes =
  ...
  | { proc_name: "disconnect_peer"; input_type: [string, string] }
  | { proc_name: "close_node"; input_type: { __taurpc_type: string } }
  | { proc_name: "get_record"; input_type: [string, string] }
  | { proc_name: "put_record"; input_type: [string, string | null, string] }
  | { proc_name: "remove_record"; input_type: [string, string] }
...
export type TauRpcApiOutputTypes =
  ...
  | { proc_name: "disconnect_peer"; output_type: null }
  | { proc_name: "close_node"; output_type: null }
  | { proc_name: "get_record"; output_type: null }
  | { proc_name: "put_record"; output_type: null }
  | { proc_name: "remove_record"; output_type: null }
...
const ARGS_MAP = {
  "":
    "{\"get_record\":[\"node_key\",\"record_key\"],\"close_node\":[\"node_id\"],\"bootstrap_nodes_changed\":[\"bootstrap_nodes\"],\"routing_table_changed\":[\"routing_table\"],\"remove_record\":[\"node_key\",\"record_key\"],\"add_bootstrap_node\":[\"key\"],\"record_store_changed\":[\"records\"],\"remove_bootstrap_node\":[\"key\"],\"put_record\":[\"node_key\",\"record_key\",\"value\"],\"disconnect_peer\":[\"node_id\",\"connect_peer_id\"],\"new_node\":[]}",
};

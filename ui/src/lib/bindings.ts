...
const ARGS_MAP = {
  "":
    "{\"new_node\":[],\"put_record\":[\"node_key\",\"record_key\",\"value\"],\"routing_table_changed\":[\"routing_table\"],\"bootstrap_nodes_changed\":[\"bootstrap_nodes\"],\"add_bootstrap_node\":[\"key\"],\"remove_bootstrap_node\":[\"key\"]}",
};
